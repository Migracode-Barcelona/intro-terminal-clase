...
### Introduction to React-Router <a href="#introduction-to-react-router" id="introduction-to-react-router"></a>
...
> **Exercise A** Open the `pokedex` React application. In this exercise, React-Router will be introduced. Instead of displaying all your components in the same page, we will use React-Router to define different pages in the `pokedex` application.
>
